...
class OrganizationProfilesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create organization_profile" do
    assert_difference('OrganizationProfile.count') do
      post organization_profiles_url, params: { organization_profile: { address: @organization_profile.address, city: @organization_profile.city, facebook_link: @organization_profile.facebook_link, img: @organization_profile.img, instagram_link: @organization_profile.instagram_link, linkedin_link: @organization_profile.linkedin_link, phone: @organization_profile.phone, snapchat_link: @organization_profile.snapchat_link, twitter_link: @organization_profile.twitter_link, type: @organization_profile.type, website_link: @organization_profile.website_link, whatsup_link: @organization_profile.whatsup_link } }
    end
  ...
  test "should update organization_profile" do
    patch organization_profile_url(@organization_profile), params: { organization_profile: { address: @organization_profile.address, city: @organization_profile.city, facebook_link: @organization_profile.facebook_link, img: @organization_profile.img, instagram_link: @organization_profile.instagram_link, linkedin_link: @organization_profile.linkedin_link, phone: @organization_profile.phone, snapchat_link: @organization_profile.snapchat_link, twitter_link: @organization_profile.twitter_link, type: @organization_profile.type, website_link: @organization_profile.website_link, whatsup_link: @organization_profile.whatsup_link } }
